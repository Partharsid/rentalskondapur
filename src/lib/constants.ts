export const BROKER_PHONE = process.env.NEXT_PUBLIC_BROKER_PHONE;
...
export const SITE_DESCRIPTION =
  'Find the best rental houses in Kondapur. No visiting fee, only brokerage. 1 BHK, 2 BHK, 3 BHK available.';
